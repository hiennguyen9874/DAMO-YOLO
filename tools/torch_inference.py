...
def make_parser():
    ...
    parser.add_argument("--conf", default=0.6, type=float, help="conf of visualization")

    parser.add_argument("--img_size", default=640, type=int, help="test img size")
    return parser
...
def main():
    ...
    model.eval()
    logger.info("Model Summary: {}".format(get_model_info(model, (args.img_size, args.img_size))))
    ...
    out_img = vis(origin_img, bboxes, scores, cls_inds, conf=args.conf, class_names=COCO_CLASSES)
